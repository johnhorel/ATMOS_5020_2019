...
> ## Assignment #1 is Due on August 30th.  
> Use lab time today and Thursday to work on this.
...
A shell script must begin with the line
...
2. Copy your HTML file, and all necessary files (e.g. images), to your `public_html` directory on the CHPC server.
    - `scp thisFile.html uXXXXXXX@meteo07.chpc.utah.edu:public_html/`
    - `scp thisImage.png uXXXXXXX@meteo07.chpc.utah.edu:public_html/`
