...
> **5 questions**. Use lab time today to finish this. You'll be happier if it is done before the Holiday.

> # Today's Objectives
> - Introduction to HTML
> - Lab time to work on/finish Assignment 1.

We have moved files and images to CHPC and made them accessible via the web. This is a rather boring way to look at images. Next, we will learn how to make basic websites.
...
# ❓ "How do I make my webpage visible on the internet?"
