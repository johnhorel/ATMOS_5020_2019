...
# Classroom: WBB 711
❗❗ **You will sit at the same computer all semester** ❗❗ (so choose wisely).  Your **username** and **password** are the ones you use for Canvas, CIS, umail, etc.

> Who here is familiar with a Mac and who is familiar with a PC?
...
- Dock or undock unnecessary programs.
...
- Class sessions will be held in 711 WBB that allows for a mix of instructional styles.
    ...
    - Independent lab work. You are being given considerable time in the lab to complete assignments. Take advantage of this time.
...
> **Question:**  
>What hardware does your Mac have? How much RAM does it have? What type of processor? **Click the Apple menu at the top and select "About this Mac."**
...
- It is a command interpreter, meaning you type commands and press enter to execute  commands.
...
Let us know if it says something besides `bash`.
...
▶ Watch this video for more info. Some of it will be over your head, but you will pick up a few things of how the Linux file system is organized: https://youtu.be/HbgzrKJvDRw 
...
Right click on the image as “Save Image As” to your Desktop.
