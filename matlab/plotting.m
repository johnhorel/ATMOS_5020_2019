...
figure(5)
%the apostrophe is the transpose operator, flip row to column
...
%read shapefiles
lakes = shaperead('data/lk24ap09.shp','UseGeoCoords',true,'BoundingBox',bbox,...
              'Attributes',{'NAME','FEATURE'});

roads = shaperead('data/roadtrl020.shp','UseGeoCoords',true,'BoundingBox',bbox,...
                'Attributes',{'NAME','FEATURE'});
...
ncid=netcdf.open('data/KMTX_terrain.nc','NC_NOWRITE');
%get all the info on the netcdf file
all_info = ncinfo('data/KMTX_terrain.nc');
