...
In the Anaconda Launcher, click on the "Environments" tab. Expplore the packages you have downloaded, and search for ones you don't have.
- `xarray`
- `netcdf4`
- `cartopy`
- `metpy`
...
1. This will download the modules specified in the file. It checkes for dependencies (extra modules relied the packages rely on) and for campatability between the versions.
