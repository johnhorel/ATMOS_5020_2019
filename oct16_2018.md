...
- Text Books: Recommended. _A Hands-On Introduction to Using Python in the Atmospheric and Oceanic Sciences_. Chapters can be downloaded for free from  http://www.johnny-lin.com/pyintro/ 
...
- Focus on the linux computing environment using  the open source Python language
...
- You are being given considerable time in the lab to complete assignments- take advantage of this.
...
- You should have time to complete assignments during class, or you need to take advantage of computers in other Labs on campus
...
You can send questions using Canvas, BUT a better way may be to use **Teams**!
